...
//     assert.strictEqual(outputList(list), "1234");
//   });
//   it("iterative version prints 1 2 3 4 to console", function () {
//     assert.strictEqual(outputListLoop(list), "1234");
//   });
//   it("recursive version prints 4 3 2 1 to console", function () {
//     assert.strictEqual(reverseList(list), "4321");
//   });
//   it("loop version prints 4 3 2 1 to console", function () {
//     assert.strictEqual(reverseListLoop(list), "4321");
//   });
// });
