let lengths = ["Bilbo", "Gandalf", "Nazgul"].map(function (name, index) {
  return index + ": " + name.slice(0, 3);
});
...
let mult = arr.reduce(function (product, current) {
...
let max2 = arr.reduce(function (max, current) {
