...
// import { myCallback, cube, cubeSquare } from "../src/fnExps.js";
// import { runResult } from "../src/app.js";
...
// describe("myMap : testArray = [-10, 0, 10, 20]", function () {
...
// //     Write this as an anonymous function expression.
// //     Then write it using an arrow expression. */
// describe("myMap triples Array: testArray = [-10, 0, 10, 20]", function () {
//   const testArray = [-10, 0, 10, 20];
//   it("tests myMap on triples anonymous function", function () {
//     assert.deepStrictEqual(myMap(testArray, triples), [-30, 0, 30, 60]);
//   });
//   it("tests myMapArrow function", function () {
