...
// // Practing Destrcuture
// const arr = [1, 2, 3, 4, 5];
// const [a, b, c] = arr;
// // when ever complier see's bracket at left it means time for destructure
// // its pure
// console.log("Array is same", arr);
// console.log(a, b, c);

// const [first, secound, ...everyoneElse] = arr;
// console.log("First is ", first);
// console.log("Sec is ", secound);
